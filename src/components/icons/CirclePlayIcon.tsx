...
const CirclePlayIconBase = createSvgIcon(
  <svg
    width={"24"}
    height={"24"}
    viewBox={"0 0 24 24"}
...
export type CirclePlayIconProps = SvgIconProps & {
  strokeWidth?: number | string;
};

const CirclePlayIcon = React.forwardRef<SVGSVGElement, CirclePlayIconProps>(
