...
const ClipboardCheckIconBase = createSvgIcon(
  <svg
  ...
  "ClipboardCheckIconBase",
);

export type ClipboardCheckIconProps = SvgIconProps & {
  strokeWidth?: number | string;
};

const ClipboardCheckIcon = React.forwardRef<
  SVGSVGElement,
