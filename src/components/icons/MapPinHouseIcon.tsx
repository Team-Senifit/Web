...
const MapPinHouseIconBase = createSvgIcon(
  <svg
...
export type MapPinHouseIconProps = SvgIconProps & {
  strokeWidth?: number | string;
};

const MapPinHouseIcon = React.forwardRef<SVGSVGElement, MapPinHouseIconProps>(
